...
Refer to the [snippet grammar](https://code.visualstudio.com/docs/editing/userdefinedsnippets#_grammar) for more details and how to unleash the full potential of transformations.
...
* [Windows 64 bit](https://update.code.visualstudio.com/latest/win32-x64-user/insider)
* [Windows 32 bit](https://update.code.visualstudio.com/latest/win32-user/insider)
