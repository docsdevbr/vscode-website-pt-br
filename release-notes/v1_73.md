...
There are new [audio cues](https://code.visualstudio.com/docs/configure/accessibility/accessibility#_audio-cues) to help with Tasks and the Terminal.
...
Word wrapping had been disabled when running VS Code in [screen reader mode](https://code.visualstudio.com/docs/configure/accessibility/accessibility#_screen-reader-mode) to prevent a degraded screen reader experience. This has been fixed and can be enabled via `editor.wordWrap`.
