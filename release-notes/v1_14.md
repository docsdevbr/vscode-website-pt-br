...
Downloads: [Windows](https://update.code.visualstudio.com/1.14.2/win32/stable) | [Mac](https://update.code.visualstudio.com/1.14.2/darwin/stable) | Linux 64-bit: [.tar.gz](https://update.code.visualstudio.com/1.14.2/linux-x64/stable) [.deb](https://update.code.visualstudio.com/1.14.2/linux-deb-x64/stable) [.rpm](https://update.code.visualstudio.com/1.14.2/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://update.code.visualstudio.com/1.14.2/linux-ia32/stable) [.deb](https://update.code.visualstudio.com/1.14.2/linux-deb-ia32/stable) [.rpm](https://update.code.visualstudio.com/1.14.2/linux-rpm-ia32/stable)
...
Consult the [tasks documentation](https://code.visualstudio.com/docs/debugtest/tasks) for a detailed list of new features and how to use them as well as instructions on how to best convert a `0.1.0` version `tasks.json` file to a `2.0.0`.
