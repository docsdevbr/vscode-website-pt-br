...
Downloads: [Windows](https://update.code.visualstudio.com/1.8.1/win32/stable) | [Mac](https://update.code.visualstudio.com/1.8.1/darwin/stable) | Linux 64-bit: [.tar.gz](https://update.code.visualstudio.com/1.8.1/linux-x64/stable) [.deb](https://update.code.visualstudio.com/1.8.1/linux-deb-x64/stable) [.rpm](https://update.code.visualstudio.com/1.8.1/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://update.code.visualstudio.com/1.8.1/linux-ia32/stable) [.deb](https://update.code.visualstudio.com/1.8.1/linux-deb-ia32/stable) [.rpm](https://update.code.visualstudio.com/1.8.1/linux-rpm-ia32/stable)
