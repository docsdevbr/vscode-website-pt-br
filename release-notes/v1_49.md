...
These reasons are shown when you try to [apply a refactoring with a keybinding](https://code.visualstudio.com/docs/editing/refactoring#_keybindings-for-code-actions).
