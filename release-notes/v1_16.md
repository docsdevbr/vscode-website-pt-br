...
Downloads: [Windows](https://update.code.visualstudio.com/1.16.1/win32-x64/stable) | [Mac](https://update.code.visualstudio.com/1.16.1/darwin/stable) | Linux 64-bit: [.tar.gz](https://update.code.visualstudio.com/1.16.1/linux-x64/stable) [.deb](https://update.code.visualstudio.com/1.16.1/linux-deb-x64/stable) [.rpm](https://update.code.visualstudio.com/1.16.1/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://update.code.visualstudio.com/1.16.1/linux-ia32/stable) [.deb](https://update.code.visualstudio.com/1.16.1/linux-deb-ia32/stable) [.rpm](https://update.code.visualstudio.com/1.16.1/linux-rpm-ia32/stable)
...
We added a new [Emmet topic](https://code.visualstudio.com/docs/languages/emmet) describing VS Code's Emmet support. Learn about using Emmet abbreviations during your editing sessions, how to customize your Emmet experience, and even create custom Emmet snippets.
