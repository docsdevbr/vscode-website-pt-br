...
Find and install cool extensions by searching VS Code's public [Extension Marketplace](/docs/configure/extensions/extension-marketplace.md).  There you'll find new themes, snippets, languages and tools.
