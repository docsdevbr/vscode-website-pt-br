...
Downloads: [Windows](https://update.code.visualstudio.com/1.17.2/win32-x64/stable) | [Mac](https://update.code.visualstudio.com/1.17.2/darwin/stable) | Linux 64-bit: [.tar.gz](https://update.code.visualstudio.com/1.17.2/linux-x64/stable) [.deb](https://update.code.visualstudio.com/1.17.2/linux-deb-x64/stable) [.rpm](https://update.code.visualstudio.com/1.17.2/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://update.code.visualstudio.com/1.17.2/linux-ia32/stable) [.deb](https://update.code.visualstudio.com/1.17.2/linux-deb-ia32/stable) [.rpm](https://update.code.visualstudio.com/1.17.2/linux-rpm-ia32/stable)
...
To learn more, check out our [snippet grammar](https://code.visualstudio.com/docs/editing/userdefinedsnippets#_snippet-syntax) to see what you can do and then get creative.
