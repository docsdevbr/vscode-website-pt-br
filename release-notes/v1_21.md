...
Downloads: [Windows](https://update.code.visualstudio.com/1.21.1/win32-x64/stable) | [Mac](https://update.code.visualstudio.com/1.21.1/darwin/stable) | Linux 64-bit: [.tar.gz](https://update.code.visualstudio.com/1.21.1/linux-x64/stable) [.deb](https://update.code.visualstudio.com/1.21.1/linux-deb-x64/stable) [.rpm](https://update.code.visualstudio.com/1.21.1/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://update.code.visualstudio.com/1.21.1/linux-ia32/stable) [.deb](https://update.code.visualstudio.com/1.21.1/linux-deb-ia32/stable) [.rpm](https://update.code.visualstudio.com/1.21.1/linux-rpm-ia32/stable)
...
When running scripts in `package.json` files as [tasks](https://code.visualstudio.com/docs/debugtest/tasks#_task-autodetection) using **Terminal** > **Run Tasks**, scripts from `package.json` files in subfolders are now also detected. To exclude folders from script detection, use the `npm.exclude` setting.
