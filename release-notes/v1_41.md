...
The Code Action and Refactoring menus now display [custom keybindings](https://code.visualstudio.com/docs/editing/refactoring#_keybindings-for-code-actions), if they exist.
